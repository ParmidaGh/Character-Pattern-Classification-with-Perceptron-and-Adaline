...
# Training function using Adaline(Delta) Rule
    ...
    while not stop_point and updating_num < 1000000:
        for i in range(len(target)):
            ...
            if output_vector[i] != target[i]:
                ...
                # Compute the weight change using Adaline rule
...
def run(w0, b, threshold, learning_rate):
    ...
    # Calculate and print average error rates for training and testing
