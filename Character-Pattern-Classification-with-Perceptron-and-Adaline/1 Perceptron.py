...
# 4-1-الف different w0 and bias
# run(0.1, 0.1, 0, 0.1)
# run(0.5, -0.2, 0, 0.1)
# run(-2, 2, 0, 0.1)
run(0.3, 0.9, 0, 0.1)     # =======> best values

# 4-1-ب different threshold
# run(0.01, 0, 0.1, 0.1)
# run(0.01, 0, 1, 0.1)
# run(0.01, 0, 10, 0.1) 
# run(0.01, 0, -0.1, 0.1)

# 4-1-ج different learning rate
# run(0.01, 0.1, -0.1, 0.02)
# run(0.01, 0.1, -0.1, 0.1)
# run(0.01, 0.1, -0.1, 0.3)
# run(0.01, 0.1, -0.1, 0.5)